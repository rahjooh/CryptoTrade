...
<<<<<<< HEAD
  github.com/aws/aws-sdk-go-v2/service/s3tables v1.22.0
=======
    github.com/aws/aws-sdk-go-v2/service/s3tables v1.7.0
>>>>>>> 6399500 (configure aws-sdk-go-v2 with old vers)
