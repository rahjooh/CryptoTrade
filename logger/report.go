...
func logReport(ctx context.Context, log *Log) {
	...
	data = append(data,
		...
		cwtypes.MetricDatum{MetricName: aws.String("Hadi-IngestRate"), Unit: cwtypes.StandardUnitCount, Value: aws.Float64(float64(ingest) / reportInterval.Seconds())},
		cwtypes.MetricDatum{MetricName: aws.String("Hadi-DroppedMessages"), Unit: cwtypes.StandardUnitCount, Value: aws.Float64(float64(droppedDelta))},
		cwtypes.MetricDatum{MetricName: aws.String("Hadi-RetryCount"), Unit: cwtypes.StandardUnitCount, Value: aws.Float64(float64(retryDelta))},
		cwtypes.MetricDatum{MetricName: aws.String("Hadi-ParquetWriteErrors"), Unit: cwtypes.StandardUnitCount, Value: aws.Float64(float64(parquetDelta))},
	)
